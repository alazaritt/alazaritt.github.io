...
## Diagram Link
A direct link to the source file of the following block diagram can be found [here](https://github.com/alazaritt/alazaritt.github.io/releases/download/blockdiagram/individual.block.diagram.drawio).
